/**
 * \class AnaBkg
 * \ module for generating bkg for pile up 
 * \author Abinash Pun
 *
 * 
 */
...
int AnaBkg::process_event(PHCompositeNode* topNode) {
  ...
  //  int n=0;
	...
	++iter) {
      ...
      std::cout << "=============================================================== pid from primary particle range " << pdg[n]<<std::endl;//" parent id: "<<par->get_parent_id()<<std::endl;
...
int AnaBkg::InitEvalTree() { 
  ...
  //tree1->Branch("mother_PDG",mother_PDG,"mother_PDG[n_parents]/I");
  tree1->Branch("coll_vtx", &coll_vtx, 256000, 99);
  //tree1->Branch("_extPDG",           _extPDG,                 "_extPDG[n]/I");  
