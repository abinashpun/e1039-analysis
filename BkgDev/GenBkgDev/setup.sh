...
source /seaquest/users/apun/abi_project/inclusive_bkg/phpyhia8_filter/core-inst/this-e1039.sh
export LD_LIBRARY_PATH=$DIR_TOP/inst/lib:$LD_LIBRARY_PATH

function cmake-ana-genbkg {
...
if [ ${HOSTNAME:0:13} != 'spinquestgpvm' ] ; then
    echo "!!CAUTION!!"
    echo "This GenBkgDev package does not support your computer ($HOSTNAME)."
